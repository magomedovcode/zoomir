    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Введите название категории товара', max_length=50, verbose_name='Название категории')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название категории атрибутов товара', max_length=50, unique=True, verbose_name='Название категории атрибутов')),
            ],
            options={
                'verbose_name': 'Категория атрибутов',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название бренда производителя', max_length=20, unique=True, verbose_name='Название бренда')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название страны производства', max_length=30, unique=True, verbose_name='Название страны')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address', models.CharField(help_text='Введите адрес для доставки заказа', max_length=255, verbose_name='Адрес для доставки заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.TextField(help_text='Введите название товара', verbose_name='Название товара')),
                ('description', models.TextField(help_text='Введите описание товара', verbose_name='Описание товара')),
                ('brand', models.ForeignKey(blank=True, help_text='Выберите бренд товара', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shop.brand', verbose_name='Бренд товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название раздела товара', max_length=50, unique=True, verbose_name='Название раздела')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название вариации товара', max_length=50, verbose_name='Название вариации товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_variant', models.ForeignKey(help_text='Выберите вариацию товара', on_delete=django.db.models.deletion.CASCADE, related_name='connected_tags', to='shop.productvariant', verbose_name='Вариация товара')),
            ],
            options={
                'verbose_name': 'Подключенный тег',
                'verbose_name_plural': 'Подключенные теги',
                'ordering': ['id'],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название атрибута товара', max_length=50, verbose_name='Название атрибута')),
                ('value', models.CharField(help_text='Введите значение атрибута товара', max_length=100, verbose_name='Значение атрибута')),
                ('attribute_category', models.ForeignKey(help_text='Выберите категорию атрибута товара', on_delete=django.db.models.deletion.CASCADE, related_name='attributes', to='shop.attributecategory', verbose_name='Категория атрибута товара')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'indexes': [models.Index(fields=['name'], name='shop_tag_name_971c74_idx')],
            },
        ),
        migrations.AddField(
            model_name='productvariant',
            name='tags',
            field=models.ManyToManyField(related_name='product_variants', through='shop.ConnectedTag', to='shop.tag', verbose_name='Теги вариации'),
        ),
        migrations.AddField(
            model_name='connectedtag',
            name='tag',
            field=models.ForeignKey(help_text='Выберите тег', on_delete=django.db.models.deletion.CASCADE, related_name='connected_tags', to='shop.tag', verbose_name='Тег'),
        ),
        migrations.CreateModel(
            name='UserTag',
            fields=[
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['date'], name='shop_favori_date_cb3e02_idx'),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('product_variant', 'attribute_category', 'name'), name='unique_attributes_per_category_per_product_variant'),
        ),
        migrations.AddIndex(
            model_name='review',
            index=models.Index(fields=['date'], name='shop_review_date_e01a17_idx'),
        ),
        migrations.AddConstraint(
            model_name='review',
        ...
        migrations.AddConstraint(
            model_name='connectedtag',
            constraint=models.UniqueConstraint(fields=('product_variant', 'tag'), name='unique_tags_per_product_variant'),
        ),
        migrations.AddConstraint(
            model_name='usertag',
