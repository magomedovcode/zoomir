# Generated by Django 5.2.6 on 2025-09-15 14:54

import django.core.validators
import django.db.models.deletion
import shop.models.brand_model
import shop.models.country_model
import shop.models.product_image_model
import shop.models.review_photo_model
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(help_text='Загрузите логотип бренда производителя', upload_to=shop.models.brand_model.brand_logo_path, verbose_name='Логотип бренда')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flag', models.ImageField(help_text='Загрузите флаг страны производства', upload_to=shop.models.country_model.manufacturer_flag_path, verbose_name='Флаг страны')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brand', models.ForeignKey(help_text='Выберите бренд товара', on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shop.brand', verbose_name='Бренд товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Введите название вариации', max_length=100, verbose_name='Вариация продукта')),
                ('price', models.DecimalField(decimal_places=2, help_text='Введите цену за вариацию продукта', max_digits=10, verbose_name='Цена за вариацию')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, help_text='Введите цену за товар на момент покупки', max_digits=10, verbose_name='Цена за товар на момент покупки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(help_text='Загрузите изображение товара', upload_to=shop.models.product_image_model.product_image_path, verbose_name='Изображение товара')),
                ('product_variant', models.ForeignKey(help_text='Выберите вариацию продукта', on_delete=django.db.models.deletion.CASCADE, related_name='product_images', to='shop.productvariant', verbose_name='Вариация продукта')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(help_text='Загрузите фотографию к отзыву', upload_to=shop.models.review_photo_model.review_photo_path, verbose_name='Фотография к отзыву')),
