<template>
  <div class="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 lg:py-40">
        <div class="text-center">
          <h1 class="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 tracking-tight">
            <span class="bg-gradient-to-r from-white via-white/90 to-white/80 bg-clip-text text-transparent animate-fade-in-up">
              Zoomir
            </span>
          </h1>

          <p class="text-xl md:text-2xl lg:text-3xl mb-10 max-w-3xl mx-auto opacity-90 animate-fade-in-up animation-delay-300">
          ...
          <div class="animate-fade-in-up animation-delay-500">
            <router-link
                to="/chapters"
                class="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-indigo-600 bg-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 overflow-hidden"
            >
    ...
    <section class="py-20 relative">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-fade-in-up">
          <h2 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-600 to-purple-700 bg-clip-text text-transparent mb-4">
            Категории товаров
          </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div
              ...
              :key="chapter.id"
              class="group relative bg-white rounded-2xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-500 cursor-pointer overflow-hidden transform hover:-translate-y-2 animate-fade-in-up"
          ...
          >
            ...
            <div class="absolute top-0 right-0 w-20 h-20 -mr-6 -mt-6 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 opacity-10 group-hover:opacity-20 transition-opacity duration-500"></div>
    ...
    <section class="py-20 bg-gradient-to-br from-white to-gray-50/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div
              v-for="i in 8"
              :key="i"
              class="bg-gradient-to-br from-gray-200 to-gray-300 rounded-2xl h-80 animate-pulse shadow-sm"
          ></div>
        </div>
        ...
        <div class="text-center animate-fade-in-up animation-delay-800">
          <router-link
              to="/chapters"
              class="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-indigo-600 to-purple-700 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 hover:scale-105 overflow-hidden"
          >
            <span class="relative z-10 flex items-center">
              <svg class="w-5 h-5 mr-3 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-20 bg-gradient-to-r from-indigo-600 to-purple-700 text-white">
      <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h2 class="text-3xl md:text-4xl font-bold mb-6">Готовы порадовать своего питомца?</h2>
        <p class="text-xl opacity-90 mb-8">Присоединяйтесь к тысячам довольных владельцев домашних животных</p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <router-link
              to="/chapters"
              class="px-8 py-4 bg-white text-indigo-600 font-bold rounded-2xl hover:bg-gray-100 transition-all duration-300 transform hover:-translate-y-1 shadow-lg"
          >
            Начать покупки
          </router-link>
        </div>
