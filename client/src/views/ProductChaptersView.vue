    ...
    <div class="flex-grow container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        >
          ...
          <div class="absolute top-0 right-0 w-24 h-24 -mr-6 -mt-6 rounded-full bg-gradient-to-r from-yellow-500 to-amber-500 opacity-10 group-hover:opacity-20 transition-opacity duration-500"></div>
      ...
      <div class="mt-8 md:mt-16 bg-gradient-to-r from-stone-800 to-stone-700 rounded-xl md:rounded-2xl p-6 md:p-8">
        <div class="flex flex-col items-center text-center md:items-center md:text-left space-y-6 md:space-y-0 md:flex-row md:justify-between">
          <div class="flex flex-col items-center md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
            <div class="w-10 h-10 md:w-12 md:h-12 bg-yellow-400 rounded-lg md:rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div class="max-w-xl">
              <h3 class="text-base md:text-lg font-semibold text-white mb-2">Не нашли нужную категорию?</h3>
              <p class="text-sm md:text-base text-white/90 leading-relaxed">Свяжитесь с нами - мы поможем подобрать товары для вашего питомца</p>
            </div>
          </div>
