    ...
    <div class="flex-grow container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else class="text-center py-16 max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl shadow-lg border border-stone-300 p-12">
          ...
          <h3 class="text-2xl font-bold text-stone-800 mb-4">В избранном пока пусто</h3>
          <p class="text-stone-600 mb-8">Добавляйте товары в избранное, чтобы не потерять и легко найти их позже</p>
          <div class="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
            ...
            <router-link
                to="/"
                class="inline-flex items-center px-6 py-3 border-2 border-stone-300 text-stone-700 font-medium rounded-xl hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-300"
            >
              На главную
            </router-link>
          </div>
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center p-8 bg-gradient-to-r from-stone-800 to-stone-700 rounded-2xl shadow-sm">
        ...
        <button
            ...
            class="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-yellow-500 to-amber-500 text-stone-800 font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
        >
