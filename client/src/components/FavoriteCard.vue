  ...
  <div class="bg-white rounded-2xl shadow-lg border border-stone-300 hover:shadow-2xl transition-all duration-500 group transform hover:-translate-y-1 relative overflow-hidden">
    <div class="relative z-10">
      <router-link :to="`/details/${product.id}`" class="block">
        <div class="p-6">
          <h3 class="font-bold text-stone-800 mb-6 line-clamp-2 text-xl leading-tight group-hover:text-yellow-600 transition-colors duration-300 min-h-[3.5rem]">
            {{ product.title }}
          </h3>
            ...
            <div class="flex items-center justify-between p-4 border-l border-stone-100 hover:border-amber-500 transition-all duration-300 group/brand">
              <div class="flex items-center space-x-3">
                <div class="w-10 h-10 bg-white rounded-lg shadow-sm border border-stone-200 flex items-center justify-center p-1.5">
                  ...
                  >
                  <svg v-else class="w-6 h-6 text-stone-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div v-if="product.description" class="mt-6 pt-4 border-t-2 border-stone-100">
          ...
          <div class="mt-6 pt-4 border-t-2 border-stone-200">
            <div class="flex items-center justify-center space-x-2 text-yellow-500 hover:text-yellow-600 font-semibold transition-colors duration-300 group/details cursor-pointer">
